            ...
            <div className="relative" style={{ zIndex: 1 }}>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-10 mb-10">
                    ...
                    <div className="flex flex-col items-center sm:items-start gap-2">
                        <h3
                            className="font-semibold text-sm uppercase tracking-widest mb-1"
                            style={{ color: '#b7e620' }}
                        >
                            Contacto
                        </h3>
                        ...
                        >
                            <svg
                                ...
                                style={{ color: '#b7e620' }}
                            >
                                <path strokeLinecap="round" strokeLinejoin="round" d={phoneIconPath} />
                            </svg>
                    ...
                    <div className="flex flex-col items-center sm:items-start gap-2">
                        ...
                        >
                            <svg
                                ...
                                style={{ color: '#b7e620' }}
                            >
                                <path strokeLinecap="round" strokeLinejoin="round" d={emailIconPath} />
                            </svg>
                ...
                <div className="mb-8">
                    <h3
                        className="text-center font-semibold text-xs uppercase tracking-widest mb-6"
                        style={{ color: '#b7e620' }}
                    >
                        Patrocinadores
                    </h3>
                ...
                <p className="text-center text-xs" style={{ color: 'rgba(255,255,255,0.2)' }}>
                    ...
                    {' Crypto Exchange. Todos los derechos reservados.'}
                </p>
