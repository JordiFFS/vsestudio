                    ...
                    <div className="flex flex-col md:flex-row">
                        ...
                        <div className="flex-1 flex flex-col justify-center gap-6 p-8 sm:p-10 md:p-14">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <p className="font-semibold text-lg tracking-wide text-gray-800">Crypto Exchange</p>
                            </div>

                            {/* Descripción */}
                            <p className="text-sm sm:text-base leading-relaxed max-w-lg text-gray-500">
                            ...
                            <div className="flex items-center gap-4">
                                <span className="text-xs uppercase tracking-widest text-gray-400">Síguenos</span>
                                {[
                                    { hover: '#000000', path: 'M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V8.69a8.27 8.27 0 004.84 1.55V6.79a4.85 4.85 0 01-1.07-.1z' },
